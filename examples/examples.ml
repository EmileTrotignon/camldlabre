...
let%node stable set delay =
  let level = [%nostream_apply count > [%nostream 0]]
  and count =
    if set then delay
    else if fby [%nostream false] (pre level) then
      [%nostream_apply pre count - [%nostream 1]]
...
let () =
  ...
  print_string
    ...
    \ resultat obtenu : " ;
  for _ = 0 to 9 do
    print ~f:print_int (alternator5 ())
  done ;
  print_string " et " ;
  for _ = 0 to 9 do
    print ~f:print_int (alternator4 ())
  done ;
  print_newline () ;
  print_string
    "Test de summed \n resultat attendu : 09090909 ...\n resultat obtenu : " ;
  for _ = 0 to 9 do
    print ~f:print_int (summed ())
  done ;
  print_newline () ;
  print_string
    "Test de if_test1 \n resultat attendu : 4545454545 ...\n resultat obtenu : " ;
  for _ = 0 to 9 do
    print ~f:print_int (if_test1 ())
  done ;
  print_newline () ;
  print_string
    "Test de if_test2 \n resultat attendu : 4545454545 ...\n resultat obtenu : " ;
  for _ = 0 to 9 do
    print ~f:print_int (if_test2 ())
  done ;
  print_newline ()
